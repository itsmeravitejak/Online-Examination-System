...
if ($handle) {
    ...
    foreach ($data['questions'] as $question) {
    	...
    	//var_dump($question['correctAnswer']);
       $q="insert into questions values(NULL,'".$question['question']."','".$question['answers'][0]."','".$question['answers'][1]."','".$question['answers'][2]."','".$question['answers'][3]."',".$question['correctAnswer'].",".$_POST['topid'].")";
    ...
    header("Location: admin.php");
  	...
  	echo "sorry! something went wrong try to upload the file again";
  }
